...
#Game Backgrounds
bgimg1 = pygame.image.load("Screen/back.jpg")
bgimg2 = pygame.image.load("Screen/back2.jpg")
...
# Game Title
pygame.display.set_caption("Snake By Ashu")
...
# GameOverScreen
            ...
            text_screen("Score: " + str(score), snakegreen, 300, 400)
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    exit_game = True
                if event.type == pygame.KEYDOWN:
            ...
            text_screen("Score:" + str(score) + "  High Score:" + str(highscore), snakegreen, 5, 5)
